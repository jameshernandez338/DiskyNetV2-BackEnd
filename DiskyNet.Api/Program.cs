...
builder.Services.AddScoped<IPendingDeliveryService, PendingDeliveryService>();
...
builder.Services.AddScoped<IPendingDeliveryRepository, PendingDeliveryRepository>();
builder.Services.AddScoped<IPasswordHasher, BCryptPasswordHasher>();
builder.Services.AddScoped<IJwtTokenGenerator, JwtTokenGenerator>();
builder.Services.AddScoped<IDbExecutor, DbExecutor>();
builder.Services.AddTransient<DbConnectionFactory>();
